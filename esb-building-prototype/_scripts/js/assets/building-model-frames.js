...
for (var i = 1; i < totalFrames + 1; i++) {
  $('body').append(`<img class="preload-image" id="preload-image-${zeroPad(i)}" src="${imagePath}/${imagePrefix}${zeroPad(i)}.jpg" alt="Bentley Residences Building Animation Frame ${i}" style="opacity: 0; height: 0;">`);
}
